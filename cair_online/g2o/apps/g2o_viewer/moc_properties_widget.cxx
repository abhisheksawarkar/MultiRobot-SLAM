...
static const char qt_meta_stringdata_PropertiesWidget[] = {
    "PropertiesWidget\0\0on_btnApply_clicked()\0"
    "on_btnOK_clicked()\0"
};
...
const QMetaObject PropertiesWidget::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PropertiesWidget,
...
void *PropertiesWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::BasePropertiesWidget"))
        return static_cast< Ui::BasePropertiesWidget*>(const_cast< PropertiesWidget*>(this));
